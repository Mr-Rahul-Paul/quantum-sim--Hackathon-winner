  ...
  const handleSimulate = async () => {
    ...
    try {
      ...
      if (data.error) {
        ...
        setResults(data);
        console.log("Simulate API response:", data);
        if (data.molecule_image) {
          // console.log("Raw molecule_image base64 (SVG):", data.molecule_image); // Optional: keep if still needed for debugging
        } else {
          // console.log("molecule_image is missing or empty in the API response."); // Optional: keep if still needed
        }
      }
    } catch {
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="rounded-lg p-6 mb-8 transition-all duration-300 bg-background hover:bg-gradient-to-br  hover:from-red-700/12 hover:to-gray-700/12 text-foreground border border-orange-500/30 shadow-sm">
                ...
                </h2>                {results && results.molecule_image ? (
                  <div className="flex flex-col items-center">
                    <div className="w-full max-w-lg bg-white rounded-lg border border-orange-500/20 p-4 shadow-lg">
                      <img
